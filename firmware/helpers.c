...
__flash const uint32_t power10[] = {
    1000000000,
    100000000,
    10000000,
    1000000,
...
/**
 * Calculate Fast CRC16 for next byte
 */
uint16_t fcrc16i(uint16_t crc16, uint8_t data)
{
    uint8_t i = (crc16 & 0xFF) ^ data;
    return (table_crc_lo[i])<<8 | ((crc16>>8) ^ table_crc_hi[i]);
}

/**
 * Calculate Fast CRC16 for block
 */
